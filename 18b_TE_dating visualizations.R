#Visualize results from TE dating
...
setwd("C:/Users/laura/OneDrive/Documenten/Bern/Universiteit/HS2023/SBL.30004_Organization & Annotation of Eukaryote Genomes/Exercises/TE dating visuals")

#import Rname landscape file with lines removed
dat <- fread("polished.fasta.Rname.tab")
